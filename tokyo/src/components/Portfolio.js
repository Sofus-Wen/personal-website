...
const detailData = [
  {
    ...
    text: [
      ...
      "&nbsp• Personalize digital experiences in education, social media, and customer engagement.",
      "&nbsp• Promote self-awareness and personal growth through accessible personality insights.",
      "&nbsp• Advance the field of computational psychology by linking language use to personality patterns.",
    ],
